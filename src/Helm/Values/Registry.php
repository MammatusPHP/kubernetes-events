...
{
    /** @var array<string, array<string|int, CronJob|Deployment|Ingress|Service>> */
    ...
    /** @return array<string, array<string|int, CronJob|Deployment|Ingress|Service>> */
